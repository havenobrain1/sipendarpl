@extends('layouts.auth', ['title' => 'Login Sekolah'])
    ...
    <div class="row w-100">
        ...
        <div class="col-lg-6">
            ...
            <div class="card border-0 shadow-sm p-4 form-card-animation">
                <h2 class="text-primary fw-bold mb-4 login-heading-animation">Login Sekolah</h2>
                ...
                <form method="POST" action="{{ route('login.sekolah') }}">
                    @csrf
                    <div class="mb-3">
